...
```{r}
print(Media_tecnica > Media_asistencia) #????
...
Con respecto a la Uso de interne… presenta el índice más bajo, mientras que … es la que tiene mayor proporción.
...
library(tidyverse)
ggplot(data = Barreras_en_la_participación_social, aes(x = `Comunidad`, y = Contacto y apoyo social `)) +  geom_bar(stat="identity", position="stack", fill="green") + ggtitle("Contacto y apoyo social ") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

```

Con respecto a la Contacto y apoyo social … presenta el índice más bajo, mientras que … es la que tiene mayor proporción.
...
library(tidyverse)
ggplot(data = Barreras_en_la_participación_social, aes(x = `Comunidad`, y = ` Actividades de ocio y culturales `)) +  geom_bar(stat="identity", position="stack", fill="green") + ggtitle("Actividades de ocio y culturales ") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

```

Con respecto a la Actividades de ocio y culturales … presenta el índice más bajo, mientras que … es la que tiene mayor proporción.
...
library(tidyverse)
ggplot(data = Barreras_en_la_participación_social, aes(x = `Comunidad`, y = ` Situación económica `)) +  geom_bar(stat="identity", position="stack", fill="green") + ggtitle("Situación económica ") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

```

Con respecto a la Situación económica … presenta el índice más bajo, mientras que … es la que tiene mayor proporción.
...
library(tidyverse)
ggplot(data = Barreras_en_la_participación_social, aes(x = `Comunidad`, y = ` Discriminación `)) +  geom_bar(stat="identity", position="stack", fill="green") + ggtitle("Discriminación ") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

```

Con respecto a la Discriminación … presenta el índice más bajo, mientras que … es la que tiene mayor proporción.
...
```{r}
summary(as.double(Barreras_en_la_participación_social $`Señala falta de ambos tipos de ayuda`), na.rm = TRUE)

summary(as.double(Barreras_en_la_participación_social $`No señala falta de ayuda`), na.rm = TRUE)

Barreras_en_la_participación_social $`Señala falta de ambos tipos de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Castilla y León"]

Barreras_en_la_participación_social $`No señala falta de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Castilla y León"]
```
...
Barreras_en_la_participación_social $`Señala falta de ambos tipos de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Aragón"]

Barreras_en_la_participación_social $`No señala falta de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Aragón"]
```
...
Barreras_en_la_participación_social $`Señala falta de ambos tipos de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Murcia, Región de"]

Barreras_en_la_participación_social $`No señala falta de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Murcia, Región de"]
```
...
Barreras_en_la_participación_social $`Señala falta de ambos tipos de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Madrid, Comunidad de"]

Barreras_en_la_participación_social $`No señala falta de ayuda`[ Barreras_en_la_participación_social $`Comunidad`== "Madrid, Comunidad de"]
``` 
