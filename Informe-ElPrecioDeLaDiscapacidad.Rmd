...
date: "Noviembre 2021"
>>>>>>> 5f5ecc4df02bf6f8875fb4f4e956f9f35d9a9a49
output:
...
<<<<<<< HEAD
![](C:\Users\usuario\Documents\INGENIERIA DE LA SALUD\3º UNI GIS\FUENTES DE DATOS BIOMEDICAS Y WEB SEMANTICAS\El precio de la discapacidad\El-precio-de-la-discapacidad\infoObjetivosSeminario.png)
=======
...
Satisfacción_con_el_entorno <- read_excel("C:/Users/Usuario/Desktop/ingenieria de la salud/5º Semestre/Fuentes de datos biomédicas y web semántica/seminario/El precio de la discapacidad/El-precio-de-la-discapacidad/DATA/Satisfaccion.xlsx")
...
La medina de los datos demográficos es 7.2422105.

* **Mínimo y máximo**

min(as.double(Satisfacción_con_el_entorno$Satisfacción), na.rm = TRUE)

Satisfacción_con_el_entorno$`Total`[Satisfacción_con_el_entorno$Satisfacción == 6.3]

La comunidad autónoma españolas con menor satisfacion es **Ceuta** con 6.3.

max(as.double(Satisfacción_con_el_entorno$Satisfacción), na.rm = TRUE)

Satisfacción_con_el_entorno$`Total`[Satisfacción_con_el_entorno$Satisfacción == 7.8]
...
library(tidyverse)
ggplot(data = Satisfacción_con_el_entorno, aes(x = `Total`, y = `Satisfacción`)) +  geom_bar(stat="identity", position="stack", fill="purple") + ggtitle("Satisfacción con el entrono") 
...
![](C:\Users\usuario\Documents\INGENIERIA DE LA SALUD\3º UNI GIS\FUENTES DE DATOS BIOMEDICAS Y WEB SEMANTICAS\El precio de la discapacidad\El-precio-de-la-discapacidad\tasa_discapacidad_ine.png)
...
![](C:\Users\usuario\Documents\INGENIERIA DE LA SALUD\3º UNI GIS\FUENTES DE DATOS BIOMEDICAS Y WEB SEMANTICAS\El precio de la discapacidad\El-precio-de-la-discapacidad\discapacidad_sexo_ine.png)
...
![](C:\Users\usuario\Documents\INGENIERIA DE LA SALUD\3º UNI GIS\FUENTES DE DATOS BIOMEDICAS Y WEB SEMANTICAS\El precio de la discapacidad\El-precio-de-la-discapacidad\densidad_poblacion_edad.png)
