...
Aunque hayamos análizado variables completamente diferentes sobre algunos aspectos de la economia de una persona discapacidas, podemos sacar una conclusión generalizada de dicha economia a grandes ragos. 
...
También es muy destacable en qué comunidades dan mayores facilidades para las personas con discapacidad a nivel financiero. Y es curioso el gran salto que hay entre comunidades de un mismo país. Teniendo encuenta que la economía de de un discapacitado es significativamente relevante para tener una mejor calidad de vida, estos es, es una parte que influye en gran medida a su vida en general.
...
Como hemos análizado tres tipos de cuidadores, mediante la comparacíon de las medias podemos determinar que hay más discapacitados viven en el hogar de la persona que los cuida que los que viven en otros hogares, siempre teniendo encuenta el posible margen de error que podrían causar los que no constan. Cabe a destacar el caso de Andalucía, por sus valores tan significativos y dispares al resto de las comunidades. En las conclusiones finales haremos un join para relacionar el set de los cuidaderos junto con el de la economia y el de ayudas, ya qeu creemos que la relacción entre los tres factores puede ser interesante en nuetra investigación.
...
Observando todos los datos obtenido y sobre todo las gráficas de cad tipo de barrera social. Hemos pocico observar qeu a pesar de que las barreras sociales en general sean muy similares en todas las comunidades analizadas, siemrpe hay alguna comunidad que destaca con el bajo indice de dichas barreras, lo cual indica qeu si otras comunidades han podido bajar ese indice en general todas las comunidades podrian llegar al mismo nivel. Evitando así o almenos disminuyendo las barreras sociales con las que tienen que lidiar las personas con dicapacidad. Sabiendo que su día a día ya de porsi es más compleja que el de resto de personas, las barreras sociales tendrían que ser mínimas en todas las comunidades, no ser un impedimento más en su vida diaría.
...
1. La calidad de vida, la satisfacción con el entorno y la esperanza de vida es mayor en comundiades con mayor poder económico, generalmente situadas en el norte de España.
...
4. En la zona rural parece haber más necesidad de ayudas importantes, pero el nivel de satisfacción de los habitantes de zonas urbanas tampoco es superior al de las zonas rurales. También existen carencias en el servicio asistenciario de las ciudades porque es díficil dar cobertura a una cantidad de población tan grande.

Relación entre satisfacción personas y no falta de ayudas??

Relación centros de salud y no falta de ayudas??

5. Relación entre los set de cuidadores, ayudar y economía de discapacitados.
