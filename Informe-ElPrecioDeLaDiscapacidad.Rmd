...
```{r}
DemPueblos <- right_join(x = Demografia, y = Pueblos, by = c("Comunidad"))
...
```{r}
PivotDemPueblos <- pivot_longer(data = DemPueblos, names_to = "Variables", values_to = "Valores", cols = c(as.double('PM10'):`Número de municipios`))
