...
library(tidyverse)
ggplot(data = Necesidades_no_satisfechas, aes(x = `Comunidades`, y = `Necesidades`)) +  geom_bar(stat="identity", position="stack")

* **Conclusiones sobre las necesidades no satisfechas de cuidados médicos**

La comunidad menos satisfecha con sus necesidades de cuidados médicos es Canarias la razón podría deberse a que al ser unas islas bastante alejadas de la Península pueden tener menos escecialistas y facilidades en sus necesidades médicas.
...
DiscEdad <- read_excel("~/INGENIERIA DE LA SALUD/3º UNI GIS/FUENTES DE DATOS BIOMEDICAS Y WEB SEMANTICAS/El precio de la discapacidad/El-precio-de-la-discapacidad/DATA/Discapacidad por edad.xlsx")
...
>>>>>>> 72f94bc4e4a6d55fe5a1881a3d82101fe05e78f1
