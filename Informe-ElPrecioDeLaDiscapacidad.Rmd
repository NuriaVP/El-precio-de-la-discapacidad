...
Iremos completando los objetivos expuestos a partir del análisis de datos reales que hemos descargado. Algunos procedimientos que emplearemos para interpretar dicha información son los siguientes:

* Tablas

* Gráficos (incluir distintos tipos de gráficos)

Tras el estudio estadístico vamos a integrar la información y redactar las conclusiones del trabajo incluyendo algunas infografías, que permitirán entender la información de forma más esquemática.
